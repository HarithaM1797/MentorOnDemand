...
public class MentorTest extends AbstractTest {
	...
	public void registerMentor() throws Exception {
		...
		Mentor mentor = new Mentor("dummy", "dummy", "dummy@gmail.com", "password", "9876543210",
	...
	public void addSkill() throws Exception {
		...
		MentorSkills mentorSkill = new MentorSkills(1, "java", "9", "01/01/2019 05:00", "505", "Online");
	...
	public void mentorConfirmation() throws Exception {
		...
		ProposalRequest proposalRequest = new ProposalRequest(1, 1, 1, "ACTIVE");
