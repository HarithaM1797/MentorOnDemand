...
public class AdminTest extends AbstractTest {
	...
	public void addSkill() throws Exception {
		String uri = "/addSkill";
		Skills skill = new Skills("angular", "700");
	...
	public void postPaymentHistory() throws Exception {
		...
		Payments payment = new Payments(101, 1, "25", "50", "75", "100");
	...
	public void updateCommission() throws Exception {
		...
		Commission commission = new Commission(20);
	...
	public void updateSlot() throws Exception {
		...
		Payments payment = new Payments(101, 1, "angular", "spring", "mysql", "oracle");
